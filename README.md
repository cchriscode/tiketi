...
현재는 **로컬 목업 단계** (Phase 0)입니다.

프로덕션 배포를 위한 상세 계획:

### 📋 문서
- **[PRODUCTION_ROADMAP.md](./PRODUCTION_ROADMAP.md)** - 전체 로드맵 (8 Phase, 3-4개월)
- **[TODO.md](./TODO.md)** - 빠른 체크리스트

### 🎯 다음 단계
1. **Phase 1**: 웹사이트 기능 완성 (결제, 검색, 모바일 등)
2. **Phase 2**: AWS 인프라 구축 (₩154k/월)
3. **Phase 3-7**: CI/CD, 최적화, 보안, 테스트
...
→ 상세 내용은 [PRODUCTION_ROADMAP.md](./PRODUCTION_ROADMAP.md) 참고
